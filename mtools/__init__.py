...
cls_model_path = os.path.join(cls_model_folder, "malware_sim%doc2vec.pth")
...
sim_model_path = os.path.join(sim_model_folder,  'malware_classification%resnet34%best.pt')  # 要使用的模型字典地址
